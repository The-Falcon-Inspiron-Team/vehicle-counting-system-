...
while ret:
    ...
    cv2.putText(frame1, "Total amount of cars :  " + str(cars), (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (0, 170, 0), 2)

    cv2.putText(frame1, "Dev By : Somporn Tongsup", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (255, 170, 0), 2)
    
        
    cv2.drawContours(frame1,contours,-1,(0,0,255),2) # เส้นประกอบรูปร่าง object (รถ)


    cv2.imshow("Original" , frame1) # ภาพสีแสดงผล
